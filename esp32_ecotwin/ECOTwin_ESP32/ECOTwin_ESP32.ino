...
<style>
*{box-sizing:border-box}body{margin:0;font-family:Inter,Segoe UI,Arial,sans-serif;background:linear-gradient(135deg,#F0FFF0 0%,#FFFFFF 62%,rgba(191,188,143,.2) 100%);color:#173326}.gateway,.form{max-width:460px;margin:7vh auto;background:#FFFFFF;border:1px solid #dce9df;border-radius:8px;padding:28px;box-shadow:0 14px 34px rgba(46,139,87,.12)}.gateway:before,.form:before{content:"";display:block;width:72px;height:72px;margin:0 auto 16px;border-radius:8px;background:linear-gradient(135deg,#2E8B57,#3CB371);box-shadow:0 8px 20px rgba(46,139,87,.16)}h1{text-align:center;font-size:22px;margin:0 0 8px}.sub{text-align:center;color:#5f6f66;font-size:14px}.actions{display:grid;gap:10px;margin-top:18px}.btn{border:1px solid #dce9df;background:#FFFFFF;color:#173326;border-radius:8px;padding:12px 14px;font-weight:800;cursor:pointer;text-decoration:none;text-align:center}.btn:hover{background:#F0FFF0}.primary{background:#2E8B57;color:white;border-color:#2E8B57}.primary:hover{background:#3CB371;border-color:#3CB371}.field{display:grid;gap:6px;margin:13px 0}.field label{font-size:14px;font-weight:700}.field input{height:44px;border:1px solid #dce9df;border-radius:8px;padding:0 12px;font:inherit}.field input:focus{outline:0;border-color:#3CB371;box-shadow:0 0 0 3px rgba(60,179,113,.14)}.hidden{display:none!important}.top{position:sticky;top:0;background:#FFFFFF;border-bottom:1px solid #dce9df;z-index:5;box-shadow:0 8px 26px rgba(46,139,87,.08)}.bar{min-height:64px;display:grid;grid-template-columns:1fr auto;gap:12px;align-items:center;max-width:1180px;margin:auto;padding:12px 18px}.brand{font-size:20px;font-weight:800}.status{font-size:13px;color:#5f6f66;text-align:right}.nav{display:flex;gap:8px;overflow:auto;max-width:1180px;margin:auto;padding:0 18px 12px}.nav button{border:1px solid #dce9df;background:#FFFFFF;color:#173326;border-radius:8px;padding:10px 14px;font-weight:800;white-space:nowrap}.nav button.active{background:#F0FFF0;color:#2E8B57;border-color:#3CB371}.wrap{max-width:1180px;margin:auto;padding:20px 18px 42px}.grid,.houses{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px}.panel{background:#FFFFFF;border:1px solid #dce9df;border-radius:8px;padding:18px;box-shadow:0 8px 20px rgba(46,139,87,.08)}.metric{font-size:28px;font-weight:900;margin:8px 0;color:#2E8B57}.label{color:#5f6f66;font-size:13px;font-weight:800;text-transform:uppercase}.readings{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin:14px 0}.reading{background:#F0FFF0;border:1px solid #dce9df;border-radius:8px;padding:12px}.reading strong{display:block;font-size:21px}.controls{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.toggle{border:1px solid #dce9df;background:#FFFFFF;border-radius:8px;padding:11px 8px;font-weight:800}.toggle.on{background:#F0FFF0;border-color:#3CB371;color:#2E8B57}.log{display:grid;gap:8px}.log div{padding:10px;border:1px solid #dce9df;border-radius:8px;background:#FFFFFF}.error{color:#b91c1c;min-height:20px}@media(max-width:800px){.metrics,.grid,.houses,.readings,.controls{grid-template-columns:1fr}.bar{grid-template-columns:1fr}.status{text-align:left}}
</style></head><body>
