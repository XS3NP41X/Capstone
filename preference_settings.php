...
// Returns the indicator styling for status.
...
// Returns the label text for status.
...
// Builds the badge output for maintenance status display.
...
<head>
  ...
  <style>
    ...
    body.preference-settings-page .settings-form-switcher,
    body.preference-settings-page #profileSection,
    body.preference-settings-page .settings-grid>section.card:not(#preferencesSettings) {
      display: none !important;
    }

    body.preference-settings-page #preferencesSettings {
...
<body class="<?= htmlspecialchars("settings-page preference-settings-page {$themeClass} {$layoutClass} {$fontSizeClass} {$fontStyleClass}") ?>"
  ...
  <main class="main-content">
    ...
    <div class="page-header-row">
      <div class="page-header mb-0">
        <h1 class="page-title">Preference Settings</h1>
        <p class="page-subtitle">Adjust appearance, language, timezone, and notification behavior on a dedicated page.</p>
  ...
  <?php if ($isAdmin): ?>
    ...
    <div class="modal-overlay" id="maintenanceModal">
      <input type="text" id="account_username" value="<?= htmlspecialchars($accountRow['username']) ?>" maxlength="60" pattern="[A-Za-z0-9]+" title="Username must contain only letters and numbers." />
      <div class="modal-box">
  ...
  <script>
    ...
    // ── Navbar dropdown ────────────────────────────────────────────────────────
    // Collects preferences values from the current form.
    ...
    // Applies preferences to document changes to the current interface.
    ...
    // Formats preference date for display.
    ...
    // Applies preferences preview changes to the current interface.
    ...
    // Returns profile payload for the current request.
    ...
    // Updates profile avatar preview based on the latest action.
    ...
    // Updates navbar avatar based on the latest action.
    ...
    // Previews profile avatar file changes before they are saved.
    ...
    // Previews profile settings changes before they are saved.
    ...
    // Opens the settings form panel or modal.
    ...
    // Opens the settings panel that matches the current URL hash.
    ...
    // ── Inline config edit ─────────────────────────────────────────────────────
    // Toggles config edit state in the interface.
    ...
    // Cancels inline editing for the selected configuration entry.
    // Cancels inline editing for the selected configuration entry.
    ...
    // ── Maintenance modal ──────────────────────────────────────────────────────
    // Opens the maintenance modal panel or modal.
    ...
    // Closes the maintenance modal panel or modal.
